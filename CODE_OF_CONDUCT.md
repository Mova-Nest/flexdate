...
- Helping newcomers feel welcome, regardless of experience level
...
- Publishing others' private information (doxing), such as a physical or email address, without their explicit permission
- Dismissing or belittling bug reports, questions, or contributions from less experienced contributors
...
- The npm package page and its comments
- Any official social media accounts or Discord/Slack channels
- Direct messages between community members in the context of the project
- Any events (online or in-person) where someone is representing the project
